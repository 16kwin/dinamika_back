...
public class TypeMaterialController {
    ...
    @PatchMapping("/{uid}")
    public ResponseEntity<SprTypeMaterialDTO> update(@PathVariable UUID uid,
            @RequestBody UpdateTypeMaterialRequest request) {
    ...
    public ResponseEntity<byte[]> exportExcel(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"type-materials.xlsx\"")
                .body(excel);
    }
    ...
    public ResponseEntity<byte[]> exportWord(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"type-materials.docx\"")
                .body(word);
    }
