...
import com.example.dinamika_back.service.ProductionDirectionColumnSettingsService;
import com.example.dinamika_back.service.ProductionDirectionService;
...
@RestController
@RequestMapping("/api/production-directions")
@RequiredArgsConstructor
public class ProductionDirectionController {

    private final ProductionDirectionService directionService;
    ...
    @GetMapping
    public ResponseEntity<ProductionDirectionListResponse> getAll(@RequestParam(required = false) Integer userId) {
        return ResponseEntity.ok(directionService.getAllWithSettings(userId));
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> create(@RequestBody CreateProductionDirectionRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable UUID uid,
            @RequestBody UpdateProductionDirectionRequest request) {
    ...
    @GetMapping("/events")
    public ResponseEntity<List<ProductionDirectionEventLogDto>> getAllEvents() {
        return ResponseEntity.ok(directionService.getAllEvents());
    }

    @GetMapping("/{uid}/events")
    public ResponseEntity<List<ProductionDirectionEventLogDto>> getEvents(@PathVariable UUID uid) {
    ...
    public ResponseEntity<byte[]> exportExcel(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"production-directions.xlsx\"")
                .body(excel);
    }
    ...
    public ResponseEntity<byte[]> exportWord(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"production-directions.docx\"")
                .body(word);
    }
