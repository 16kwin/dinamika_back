// StationManufacturerController.java — ПОЛНЫЙ ФАЙЛ (добавлены эндпоинты экспорта)
...
public class StationManufacturerController {
    ...
    @PatchMapping("/{uid}")
    public ResponseEntity<StationManufacturerDto> update(@PathVariable UUID uid,
            @RequestBody UpdateStationManufacturerRequest request) {
    ...
    public ResponseEntity<byte[]> exportExcel(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"station-manufacturers.xlsx\"")
                .body(excel);
    }
    ...
    public ResponseEntity<byte[]> exportWord(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"station-manufacturers.docx\"")
                .body(word);
    }
