...
public class SupplierDirectionController {
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable UUID uid,
            @RequestBody UpdateSupplierDirectionRequest request) {
    ...
    public ResponseEntity<byte[]> exportExcel(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"supplier-directions.xlsx\"")
                .body(excel);
    }
    ...
    public ResponseEntity<byte[]> exportWord(@RequestBody Map<String, Object> request) throws Exception {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"supplier-directions.docx\"")
                .body(word);
    }
