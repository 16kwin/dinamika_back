// UserTemplateColumnSettings.java
...
@Entity
@Table(name = "user_template_column_settings")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class UserTemplateColumnSettings {
    ...
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "current_path_json", columnDefinition = "jsonb")
