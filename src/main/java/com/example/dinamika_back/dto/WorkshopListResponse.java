// WorkshopListResponse.java — НОВЫЙ DTO
...
public class WorkshopListResponse {
    ...
    private List<WorkshopFlatDto> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public WorkshopListResponse() {}

    public WorkshopListResponse(List<String> columns, List<WorkshopFlatDto> data,
    ...
    public List<WorkshopFlatDto> getData() { return data; }
    public void setData(List<WorkshopFlatDto> data) { this.data = data; }
