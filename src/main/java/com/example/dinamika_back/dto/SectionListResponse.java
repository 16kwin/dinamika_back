// SectionListResponse.java — НОВЫЙ DTO
...
public class SectionListResponse {
    ...
    private List<SectionFlatDto> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public SectionListResponse() {}

    public SectionListResponse(List<String> columns, List<SectionFlatDto> data,
    ...
    public List<SectionFlatDto> getData() { return data; }
    public void setData(List<SectionFlatDto> data) { this.data = data; }
