// StationManufacturerListResponse.java — НОВЫЙ DTO
package com.example.dinamika_back.dto;

import java.util.List;
import java.util.Map;

public class StationManufacturerListResponse {
    private List<String> columns;
    private List<StationManufacturerDto> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public StationManufacturerListResponse() {}

    public StationManufacturerListResponse(List<String> columns, List<StationManufacturerDto> data,
    ...
    public List<StationManufacturerDto> getData() { return data; }
    public void setData(List<StationManufacturerDto> data) { this.data = data; }
