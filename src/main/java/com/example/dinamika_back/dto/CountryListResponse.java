...
public class CountryListResponse {
    ...
    private List<SprCountryDTO> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public CountryListResponse() {}

    public CountryListResponse(List<String> columns, List<SprCountryDTO> data,
    ...
    public List<SprCountryDTO> getData() { return data; }
    public void setData(List<SprCountryDTO> data) { this.data = data; }
