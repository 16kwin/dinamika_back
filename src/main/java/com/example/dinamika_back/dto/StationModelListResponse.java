// StationModelListResponse.java — НОВЫЙ DTO
package com.example.dinamika_back.dto;

import java.util.List;
import java.util.Map;

public class StationModelListResponse {
    private List<String> columns;
    private List<StationModelDto> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public StationModelListResponse() {}

    public StationModelListResponse(List<String> columns, List<StationModelDto> data,
    ...
    public List<StationModelDto> getData() { return data; }
    public void setData(List<StationModelDto> data) { this.data = data; }
