// StationTypeListResponse.java — НОВЫЙ DTO
package com.example.dinamika_back.dto;

import java.util.List;
import java.util.Map;

public class StationTypeListResponse {
    private List<String> columns;
    private List<StationTypeDto> data;
    private Map<String, Double> columnWidths;
    private List<String> requiredColumns;

    public StationTypeListResponse() {}

    public StationTypeListResponse(List<String> columns, List<StationTypeDto> data,
    ...
    public List<StationTypeDto> getData() { return data; }
    public void setData(List<StationTypeDto> data) { this.data = data; }
